...
<form method="POST" action="farmertable.php">
 <div class="container"><br>
   <h2>Farmer Table</h2><br><br> 
...
<div class="container" style="max-width: 90%;" ><br>
  <p>-----------------------------------------------------------------------------------------TABLE----------------------------------------------------------------------------------------------------------</p>
<div class="table-responsive" style="max-width: 130%;"> <table class="table table-bordered" style="width: 50%;">
 <thead>
<tr> <th>FIRSTNAME</th> <th>LASTNAME</th> <th>MOBILE_NUMBER</th>
<th>GENDER</th> <th>ADHAR_NUMBER</th> <th>STATE</th> <th>CITY</th>
<th>PINCODE</th> <th>LAND_AREA</th> <th>AVG_INCOME</th>
<th>AVG-PRODUCTION</th> <th>JUTE_SELLED</th> </tr>
 </thead>
  <tbody>
   <?php
...
$salaryreceived = $_POST['salaryreceived'];

 }

if(!empty($farmerstate))
{
if(!empty($farmerpincode))
{
  if(!empty($salaryreceived))
    {
    $query = mysqli_query($connection,"SELECT * FROM farmer WHERE state = '$farmerstate' AND pincode = '$farmerpincode' AND salary_received='$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
                   {
                                echo "<tr><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['mobile_number']."</td><td>".$row['gender']."</td><td>".$row['adhar_no']."</td><td>".$row['state']."</td><td>".$row['city']."</td><td>".$row['pincode']."</td><td>".$row['land_area']."</td><td>".$row['average_income']."</td><td>".$row['average_production']."</td><td>".$row['salary_received']."</td>";
...
if(empty($farmerpincode))
{
   if(empty($salaryreceived))
     {
    $query = mysqli_query($connection,"SELECT * FROM farmer");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
...
if(empty($farmerpincode))
{
   if(!empty($salaryreceived))
     {
    $query = mysqli_query($connection,"SELECT * FROM farmer WHERE state = '$farmerstate'AND salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
                   {
                                echo "<tr><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['mobile_number']."</td><td>".$row['gender']."</td><td>".$row['adhar_no']."</td><td>".$row['state']."</td><td>".$row['city']."</td><td>".$row['pincode']."</td><td>".$row['land_area']."</td><td>".$row['average_income']."</td><td>".$row['average_production']."</td><td>".$row['salary_received']."</td><td>";
...
if(!empty($farmerpincode))
{
   if(!empty($salaryreceived))
     {
    $query = mysqli_query($connection,"SELECT * FROM farmer WHERE pincode = '$farmerpincode' AND salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
...
if(empty($farmerpincode))
{
   if(!empty($salaryreceived))
     {
    $query = mysqli_query($connection,"SELECT * FROM farmer WHERE salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))

...
<form method="POST" action="farmertotalsalary.php">
 <div class="container"><br>
  <h2>Farmer Salary Table</h2><br>
...
if(isset($_POST['search'])) { $farmerstate = $_POST['state']; 
...
{
    $query = mysqli_query($connection,"SELECT  * FROM farmer WHERE state = '$farmerstate'");
          ...
          if($noofrows!=0)
            {
              ...
              $pincode="NULL";
                   ...
                   {
                    $salary = $salary + $row['average_income'];

                   }
              echo "<tr><td>".$farmerstate."</td><td>".$pincode."</td><td>".$salary."</td>";
...
if(!empty($farmerpincode))
  {
    $query = mysqli_query($connection,"SELECT  * FROM farmer WHERE state = '$farmerstate' AND pincode = '$farmerpincode'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
              $salary=0;
              ...
              echo "<tr><td>".$farmerstate."</td><td>".$farmerpincode."</td><td>".$salary."</td>";

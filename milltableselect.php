...
<form method="POST" action="milltableselect.php">
 <div class="container"><br>
   <h2>Mill Worker Table</h2><br><br> 
...
<div class="container"  style=" max-width:79%;" ><br>
  <p>-----------------------------------------------------------------------------------------------------------TABLE----------------------------------------------------------------------------------------------------------</p>
          ...
          if($noofrows!=0)
            {
                   ...
                   {
                                echo "<tr><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['mobile_number']."</td><td>".$row['gender']."</td><td>".$row['adhar_card_no']."</td><td>".$row['state']."</td><td>".$row['city']."</td><td>".$row['pincode']."</td><td>".$row['mill_name']."</td><td>".$row['mill_number']."</td><td>".$row['income']."</td><td>".$row['salary_received']."</td>";
...
if(!empty($salaryreceived))
   {
    ...
    $query = mysqli_query($connection,"SELECT * FROM mill_worker WHERE state = '$millstate' AND pincode = '$millpincode' AND salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
...
if(empty($millpincode))
  {
    $query = mysqli_query($connection,"SELECT * FROM mill_worker WHERE salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
...
if(!empty($salaryreceived))
   {
    ...
    $query = mysqli_query($connection,"SELECT * FROM mill_worker WHERE state = '$millstate'  AND salary_received = '$salaryreceived'");
    $noofrows = mysqli_num_rows($query);
          if($noofrows!=0)
            {
                   while($row = mysqli_fetch_assoc($query))
                   {
                                echo "<tr><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['mobile_number']."</td><td>".$row['gender']."</td><td>".$row['adhar_card_no']."</td><td>".$row['state']."</td><td>".$row['city']."</td><td>".$row['pincode']."</td><td>".$row['mill_name']."</td><td>".$row['mill_number']."</td><td>".$row['income']."</td><td>".$row['salary_received']."</td><td>";
